...
def generate_analysis_pdf(exam, patient, output_file, doctor=Ophthalmologist(name="Martha Luz", last_name="Zuluaga Posada", email="johndoe@example.com", medical_license="RM-5-1382-97", specialty="Oftalmólogo y Corneólogo CES"), logo="media/clinic_information/logo_clinica.png"):
    class PDF(FPDF):
        def header(self):
